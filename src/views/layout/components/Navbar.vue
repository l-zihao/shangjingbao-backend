    ...
    <div class="right-menu" style="display: flex;">
      ...
      <el-dropdown class="avatar-container right-menu-item" trigger="click">
        <div class="avatar-wrapper">
          <img class="user-avatar" :src="getAvatar(this.$store.getters.avatar)">
...
export default {
  ...
  methods: {
     getAvatar(avatar) {
          if (avatar.trim().startsWith("/static/")){
            return avatar
          } else {
            return process.env.IMG_BASE_URL + avatar.substring(avatar.lastIndexOf("/")+1)
          }
        },
    toggleSideBar() {
