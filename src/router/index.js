...
export const asyncRouterMap = [
  ...
  },
  {
    ...
    children: [{
      path: 'index',
      name: 'reward',
      component: _import('menu/reward'),
      meta: { perm:'m:reward', title: '悬赏单管理', icon: 'form' }
    }]
  },
...

  {
    ...
    children: [{
      path: 'index',
      name: 'feadback',
      component: _import('menu/feadback'),
      meta: { perm:'m:feadback', title: '用户反馈', icon: 'email' }
    }]
  },
  ...
  },
{
    ...
    children: [{
      path: 'index',
      name: 'personal',
      component: _import('menu/personal'),
      meta: { perm:'m:me', title: '个人中心', icon: 'people' }
    }]
  },
  {
    path: '/menu3',
